...
- mode: `pilot`
- source run: `/data/muscat_data/jaguir26/.rqr_gibbs_worktrees/oracle_tilt_v3_process_isolation_20260801/application/outputs/tcsp_validation_v1/pilot_main_8d7b959_p0_20260812`
- replications per cell: 8
- rows: 576
- summary rows: 72
- failures: 72
- required gate failures: 0
- failing promotion blockers: 1
