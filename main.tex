...
All panels use the standardized form of an asymmetric-Laplace population with
raw location \(0\), scale \(1\), quantile level \(0.99\), and content
\(c=0.80\). The raw location is the \(0.99\) quantile under this convention;
all targets are computed on the raw population before display coordinates
subtract its mean and divide by its standard deviation. Equal-tailed (ET)
...
For the same standardized asymmetric-Laplace distribution and \(c=0.80\), the
