...
validation design, Section~\ref{sec:pharma-application} presents the
...
\texttt{Laboratory.csv} file \citep{ZagarMihelic2021LaboratoryCsv}. The
...
Section~\ref{sec:evaluation}. The split exercise is not used to choose or tune
...
study. The supplement repeats the analysis for tablet-core weight relative
