...
reconstructed. This reparameterization is intended to reduce state--scale
dependence without changing the generalized posterior
...
the sampled time-zero states. Standardize those innovations at the centered
draw, apply the declared noncentered log-scale slice sweeps conditional on the
standardized paths, and reconstruct both root paths at the updated scales.
