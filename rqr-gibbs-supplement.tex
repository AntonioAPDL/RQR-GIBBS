...
MTI-ECM mode calculation, the direct Dirichlet-process fixed-interval
content-probability check, and the iid tolerance-validation protocol. Endpoint regression,
