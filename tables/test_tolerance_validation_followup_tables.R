...
stopifnot(grepl("Interval-production rate", design_tex, fixed = TRUE))
stopifnot(!grepl("Returned interval rate", design_tex, fixed = TRUE))
stopifnot(grepl("Content-attainment", design_tex, fixed = TRUE))
...
stopifnot(grepl("Interval-production rate", small_tex, fixed = TRUE))
stopifnot(!grepl("Returned interval rate", small_tex, fixed = TRUE))
stopifnot(grepl("Content-attainment", small_tex, fixed = TRUE))
