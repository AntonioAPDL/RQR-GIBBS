...
stopifnot(grepl("Interval-production rate", tex, fixed = TRUE))
stopifnot(!grepl("Returned interval rate", tex, fixed = TRUE))
stopifnot(grepl("Content-attainment", tex, fixed = TRUE))
